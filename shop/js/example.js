angular.module('ui.bootstrap.clothesboutique', ['ui.bootstrap']);
angular.module('ui.bootstrap.clothesboutique').controller('DropdownCtrl', function ($scope, $log) {
  $scope.items = [
    'USA',
    'Canada',
    'UK'
